...
# File name: synthetic_image_generator.py
...
class MaskJsonUtils():
    ...
    def write_masks_to_json(self):
        ...
        output_file_path = Path(self.output_dir) / 'image_mask_mapping.json'
        with open(output_file_path, 'w+') as json_file:
            json_file.write(json.dumps(masks_obj))
            
        print('Intermediate image to mask mapping is stored in ', output_file_path.absolute())
...
class ImageComposition():
    ...
    def _create_info(self):
        ...
        print('Data set info file is stored at ', output_file_path.absolute())
