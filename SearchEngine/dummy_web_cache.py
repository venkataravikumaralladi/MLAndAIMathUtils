...
def get_test_page2(url : str) -> str:
    ...
    '''
        ...
        Parameters. Actual web page reading is implemented in get_page function below.
        ----------
            url : str
                url value for which html data to be sent.

        Returns
        -------
            string of html code or empty string
    '''
    try:
...
def get_test_page_for_index(url : str) -> str:
    '''
        This is a simulated get_test_page_for_index procedure so that you can test your
        code on simulated data.
        Parameters. Actual web page reading is implemented in get_page function below.
        ----------
            url : str
                url value for which html data to be sent.
...
def get_page(url : str) -> str:
    '''
        This implements function that returns html content of requested url.
